...
List<MakeUpData> makeUpDataFromJson(String str) => List<MakeUpData>.from(json.decode(str).map((x) => MakeUpData.fromJson(x)));

String makeUpDataToJson(List<MakeUpData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
